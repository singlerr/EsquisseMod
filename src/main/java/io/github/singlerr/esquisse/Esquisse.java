...
@Mod(
        modid = Esquisse.MOD_ID,
        name = Esquisse.MOD_NAME,
        version = Esquisse.VERSION
)
public class Esquisse {

    public static final String MOD_ID = "esquisse";
    public static final String MOD_NAME = "Esquisse";
     ...
     */
    @Mod.Instance(MOD_ID)
    public static Esquisse INSTANCE;
